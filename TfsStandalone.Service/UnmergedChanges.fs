...
let Get (projectCollectionUrl, username, fromBranch, toBranch, ignoredChangesets: IEnumerable<int>, altUsername: string, altPassword: string): IEnumerable<UnmergedChange> =
